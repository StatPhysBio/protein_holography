...
#        print(scalar_output.shape)
        scalar_output = tf.squeeze(tf.concat([scalar_out_real,scalar_out_imag], axis=1),axis=-1)
#        scalar_output = tf.concat([scalar_out_real,scalar_out_imag])
