...
ds_train = get_dataset(hologram_dir, args.ch, args.e, args.L, args.k, args.d, args.rH)
ds_val = get_dataset(hologram_dir, args.ch, args.e_val, args.L, args.k, args.d, args.rH)
...
early_stopping = tf.keras.callbacks.EarlyStopping(
    monitor='loss', patience=5, mode='min', min_delta=0.0001)
