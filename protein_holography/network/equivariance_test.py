...
from protein_holography.network.dataset import get_equivariance_test_dataset, get_dataset
...
ds_eq = get_equivariance_test_dataset(input_data_dir,val_data_id,args.netL[0])
...
ds_train_trunc = ds_train.batch(args.bsize[0]).take(2)
ds_eq_trunc = ds_eq.batch(2)
...
print('Learning done')
print('\nPrediction starting')
output = network.predict(ds_eq.batch(1))
