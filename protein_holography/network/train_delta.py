...
from protein_holography.network.dataset import get_dataset, get_dataset_delta
...
hologram_dir = os.path.join(args.datadir, "deltagrams")
...
if args.k != -1:
    ds_train = get_dataset_delta(hologram_dir, args.ch, args.e, args.file_L, args.k, args.d, args.rH, args.aas)
    ds_val = get_dataset_delta(hologram_dir, args.ch, args.e_val, args.file_L, args.k, args.d, args.rH, args.aas)
